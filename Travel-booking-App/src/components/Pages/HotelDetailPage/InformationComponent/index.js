...
const handleFetchCmt = async () => {
    const response = await fetch('https://6268162901dab900f1c9969b.mockapi.io/appi/v1/comments')
    const cmtData = await response.json();
    const cmt = cmtData.filter((item) => {
         return item.idHotel === params.id
    })
    console.log('cmt', cmt)
    setCmt(cmt)
}
        ...
        <div className="detailContainer">
            
            {
                hotelDetails.map(hotelDetail => {
                    ...
                    return <div className="detailSubContainer" > 
                        ...
                        <div className="convenientContainer">
                             ...
                             {(ConvenientList.filter((icon) => icon.name == hotelDetail.convenient)) ? <img src={icons.img}/> : '1'}
                        </div>
                        <div>
                        ...
                        <div className='cmtBox'>
                              <div className='cmtTitle'>
                                    Bài đánh giá về {hotelDetail.name}
                              </div>
                              <div>
                                  <div>
                                      Rating 
